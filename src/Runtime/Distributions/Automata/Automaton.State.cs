...
namespace Microsoft.ML.Probabilistic.Distributions.Automata
{
        ...
        where TThis : Automaton<TSequence, TElement, TElementDistribution, TSequenceManipulator, TThis>, new()
    {
        ...
        /// </summary>
        /// <remarks>
        /// It is a simple wrapper around <see cref="StateData"/> which also carries information about automaton
        /// which owns this state. This allows to simplify automaton serialization (avoiding circular references)
        /// and future changes to the way states are stored.
        /// </remarks>
        public struct State
        {
